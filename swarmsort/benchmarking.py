...
class TrackingBenchmark:
    ...
    def __init__(self, 
                 tracker: Optional[SwarmSortTracker] = None,
    ...
    def benchmark_frame(self, 
                       detections: List[Detection],
                       frame_number: int) -> Tuple[List[TrackedObject], FrameTimingResult]:
    ...
    def benchmark_sequence(self, 
                          detection_sequence: List[List[Detection]],
                          progress_callback: Optional[Callable[[int, int], None]] = None) -> BenchmarkResult:
...
class ScalabilityBenchmark:
    ...
    def run_object_count_scalability(self,
                                   detection_generator: Callable[[int, int], List[List[Detection]]],
                                   object_counts: List[int],
                                   num_frames: int = 300,
                                   config: Optional[SwarmSortConfig] = None) -> Dict[str, BenchmarkResult]:
    ...
    def run_frame_count_scalability(self,
                                  detection_generator: Callable[[int, int], List[List[Detection]]],
...
def quick_benchmark(detection_sequence: List[List[Detection]], 
