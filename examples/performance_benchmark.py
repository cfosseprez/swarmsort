...
def benchmark_tracking(
    detections_sequence: List[List[Detection]], config: SwarmSortConfig
...
def run_performance_benchmark():
    ...
    # Test configurations
    configs = {
        "Basic (No Embeddings)": SwarmSortConfig(max_distance=80.0, use_embeddings=False),
        "With Embeddings": SwarmSortConfig(
            max_distance=80.0, use_embeddings=True, embedding_weight=0.5
        ),
    }
