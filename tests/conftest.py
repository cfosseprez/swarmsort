        ...
        for frame in range(num_frames):
            ...
            for i, template in enumerate(templates):
                ...
                detection = Detection(
                    ...
                    bbox=np.array([position[0]-10, position[1]-10, position[0]+10, position[1]+10]),
                    class_id=i % 5,
...
class TrackingAssertions:
    ...
    @staticmethod
    def assert_no_track_jumps(tracks_sequence: List[List[TrackedObject]], max_distance: float = 100.0):
